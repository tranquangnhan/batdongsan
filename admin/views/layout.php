...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>admin- quản lý tin bất động sản</title>
        ...
        <link href="views/assets/css/custom.css" rel="stylesheet" type="text/css" />
    </head>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="?ctrl=users&act=addnew">Thêm Mới</a></li>
                                    <li><a href="?ctrl=users&act=index">Danh Sách</a></li>
                                </ul>
                            </li>
        ...
        <?php if(file_exists($page_file)==true) require_once "$page_file"?>
              ...
              <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            2022 &copy;phát triển bởi <a href="">Quang Nhân</a>
                        </div>
